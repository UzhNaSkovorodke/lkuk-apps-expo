...
const setNotificationVisited = createAction(
  'notifications/setNotificationVisited'
);

const incrimentNotification = createAction(
  'notifications/incrimentNotification'
);
...
const fetchEventRelevanceTypes = createAsyncActionCreator(
  'EventRelevanceTypes'
);
...
const fetchNotificationStatuses = createAsyncActionCreator(
...
const fetchServiceCompanyAppeal = createAsyncActionCreator(
  'ServiceCompanyAppeal',
  'fetch',
  {
    pre: (o, dispatch) => {
      dispatch(clearAppeal());
...
const fetchEditProfileAppeal = createAsyncActionCreator(
  'EditProfileAppeal',
  'fetch',
  {
    pre: (o, dispatch) => {
...
const auth = ({ login, password }) => (dispatch, getState, api) => {
...
const authenticate = () => dispatch => dispatch(checkAuth()).then(res => dispatch(fetchProfile(res.token)));
