...
import ModalRoot, {
  openAgreementModal,
} from '../components/custom/RootModalsComponent';
...
class MyEventsTaxiPassOrderScreen extends React.Component {
  ...
  handleEditAppealRelevance = () => {
    ...
    this.props
      ...
      .finally(() =>
        this.setState(state => ({ ...state, relevanceLoading: false })),
      );
  };
          ...
          <View style={styles.scrollViewContainer}>
            ...
            {data.car && data.car.plateNumber && (
              <>
                ...
                <Text style={styles.text}>{data.car.plateNumber ? data.car.plateNumber : 'нет данных'}</Text>
                <SplitLine style={styles.underLine} />
              </>
            )}
